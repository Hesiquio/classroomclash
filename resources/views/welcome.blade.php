...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            <a href="{{ route('guest.claim.form') }}" class="btn btn-ghost" style="font-size:.875rem;">🔑 Tengo un Código</a>
    ...
    <header class="hero">
        ...
        <div class="cta-group">
            ...
            <a href="{{ route('guest.claim.form') }}" class="btn btn-outline btn-lg">🔑 Soy estudiante, tengo un código</a>
        </div>
    </header>
    ...
    <div id="loginModal" class="modal-overlay">
        <div class="modal-container">
            ...
            <div class="auth-switch" style="margin-top:.5rem; padding-top:.75rem; border-top:1px solid #e2e8f0;">
                🔑 ¿Tu docente te dio un código? <a href="{{ route('guest.claim.form') }}">Ingresa aquí</a>
            </div>
        </div>
    </div>
