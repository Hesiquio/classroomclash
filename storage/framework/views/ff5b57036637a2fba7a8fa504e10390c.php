...
<?php $__env->startSection('title', 'Dashboard Docente - Classroom Clash'); ?>
        ...
        <?php $__currentLoopData = $challenges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="challenge-card">
                ...
                <div class="challenge-footer">
                    <a href="<?php echo e(route('challenge.show', $challenge)); ?>" class="btn btn-sm btn-primary">Ver Pizarra</a>
                    <button type="button" class="btn btn-sm btn-secondary" onclick="openEditModal(<?php echo e($challenge->id); ?>, '<?php echo e($challenge->name); ?>', <?php echo e($challenge->min_points ?? 0); ?>, <?php echo e($challenge->max_points ?? 100); ?>)">
                        Editar
                    </button>
